    ...
    public static class BikeSeedConfiguration
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bike>().HasData(
                ...
                new Bike { Id = 6, Gears = 21, FrameSize = 17.5m, RimSize = 29.0m, Model= "Silver Mountain II", Description = "Silver mountain's advanced model. Equipped with RockShox front suspension, disc brakes, carbon fiber frame.", Price = 2390.90m, Image = "mountain6.png", GenderCode = "M", CategoryId = 2 },
